// src/app.ts
import { validateRecord, updateRecordWithValidation } from './index.ts';
...
const updates3: UpdatedRecord = {
    price: 'forty' as any, // Invalid price type
};
